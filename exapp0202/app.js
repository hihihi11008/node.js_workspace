...
//모듈은 사실상 파일이다(함수단위로 등록하기도한다)! 아래의 두개의 변수는 ./routes/index.js 파일을 의미한다 
var mainRouter = require('./routes/index'); //메인요청을 처리하는 컨트롤러 파일 
var memberRouter = require('./routes/member'); //users요청을 처리하는 컨트롤러 파일 
var boardRouter = require('./routes/board'); //board요청을 처리하는 컨트롤러 파일 
...
app.use(express.static(path.join(__dirname, 'public'))); //정적자원의 위치 
